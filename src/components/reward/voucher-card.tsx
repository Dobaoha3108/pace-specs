...
<div className="-translate-y-2 flex items-center gap-0">
  ...
  />
    ...
    {status === "Active" ? (
  <button
  className="-mt-4 whitespace-nowrap rounded-full border-2 border-[#B96363] bg-[#FFC3C3] px-4 py-2 text-[16px] font-bold leading-none text-[#B96363]"
        onClick={(event) => {
