...
Nếu điều kiện đúng, hiển thị Confirmation Dialog (CMP-015) trước khi lưu, với nội dung: "Nếu bạn chi tiêu khoản này, ngân sách trung bình mỗi ngày sẽ giảm từ [X] xuống [Y]", trong đó X là Remaining Budget hiện tại / số ngày còn lại của chu kỳ, Y là Remaining Budget sau khi trừ khoản chi này / số ngày còn lại của chu kỳ. Dialog có hai lựa chọn:
